  ...
  render() {
    return (
      <div className="App" style={{
        ...
        {window.innerWidth>=window.innerHeight && window.innerWidth>768 && <MainDesign dims={window.innerHeight < window.innerWidth ? window.innerHeight / 925 : window.innerWidth / 925} right={'Projects'} left={'Education'} top={'Skills'} bottom={'About me'} mid={'Abhay Upadhyay'} midSub={"Hi I'm"} showrl={this.showrl} />}
        {window.innerWidth>=window.innerHeight && window.innerWidth>768 && <Education img={this.state.img} desc={this.state.desc} showrl={this.showrl} changeDesc={this.changeDesc} title={this.state.title} />}
        {window.innerWidth>=window.innerHeight && window.innerWidth>768 && <Projects project={this.state.projects[this.state.currIndex]} changeProject={this.changeProject} showrl={this.showrl} />}
        {window.innerWidth>=window.innerHeight && window.innerWidth>768 && <AboutMe />}
      </div>
    );
  }
}
